...
function calcBinaryen(method, options) {
    ...
    xhr.open('GET','../../../static/scripts/' + wasmFileName, true);
...
// calcHash() actually computes the argon2 hash
function calcHash() {
    var arg = getArg();
...
// Below is the value we are looking for argon2 str format
